...
This is a parallel implementation of conjugate-gradient method using MPI. 
...
to compile on SCITAS clusters :

```
$ module load gcc openblas
$ make
```
The default compiler is mpicc, can be changed in the Makefile

You should see this output (for the serial version) :
